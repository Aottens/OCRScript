...
class OcrGui(QtWidgets.QWidget):
    def __init__(self) -> None:
        ...
        self.min_symbols.setValue(ocr_extract.DEFAULT_CONFIG.min_symbols)
        ...
        self.symbol_conf.setValue(ocr_extract.DEFAULT_CONFIG.symbol_conf)
    ...
    def _run(self) -> None:
        ...
        try:
            config = ocr_extract.ExtractionConfig(
                ...
                symbol_psm_modes=ocr_extract.DEFAULT_CONFIG.symbol_psm_modes,
            )
